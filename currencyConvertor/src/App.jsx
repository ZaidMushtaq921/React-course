...
function App() {
  ...
  const swap = () => {
    setFrom(to);
    setTo(from);
    setConvertedAmount(amount); // Update convertedAmount before swapping
        ...
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          <div className="w-full mb-1">
            <InputBox
              ...
              onCurrencyChange={(currency) => setFrom(currency)} // Fix the currency change handler
              selectCurrency={from}
          ...
          <div className="w-full mt-1 mb-4">
            <InputBox
              ...
              selectCurrency={to} // Set selectCurrency to 'to' instead of 'from'
              amountDisable
            />
          </div>
          <button className="w-full bg-blue-600 text-white px-4 py-3 rounded-lg" onClick={convert}> {/* Remove form submission */}
